...
export default function LicensePage() {
  return (
    <>
      <DocsHeader
        title="License"
        description="s45 is open source software licensed under the Apache License, Version 2.0"
      ...
      <DocsBody className="w-full h-[40vh] px-8 py-16 relative overflow-hidden rounded-3xl flex items-center justify-center border bg-background mb-12">
        <h1 className="text-xl tracking-tight text-foreground text-center">
            <span className="font-semibold text-3xl">s45 is open source under the Apache 2.0 License. You can see the source code, self-host & contribute.</span>
        </h1> 
        <Ripple/>
      </DocsBody>
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            s45 is distributed under the Apache License 2.0, one of the most permissive and business-friendly open source licenses available.
            This license allows you to use, modify, distribute, and sublicense s45 for both commercial and non-commercial purposes.
          </p>
        </DocsBody>
      ...
      <section className="mb-12">
        ...
        <DocsBullets variant="check" spacing="default" className="mb-8">
          <DocsBulletItem
            ...
            description="Use s45 for commercial purposes without any fees or royalties"
          />
          <DocsBulletItem
            title="Modification"
          ...
          <DocsBulletItem
            title="Distribution"
            description="Distribute original or modified versions of s45"
          />
          <DocsBulletItem
            title="Patent Use"
          ...
          <DocsBulletItem
            title="Private Use"
            description="Use and modify s45 for private purposes without any obligations"
          />
          <DocsBulletItem
            title="Sublicensing"
      ...
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            When using s45 under the Apache License 2.0, you must:
          </p>
        </DocsBody>
      ...
      <section className="mb-12">
        ...
        <DocsBullets variant="default" spacing="default" className="mb-8">
          <DocsBulletItem
            ...
            description="The license does not grant permission to use the trade names, trademarks, or service marks of s45"
          />
          <DocsBulletItem
            title="No Warranty"
        ...
        <Alert className="mb-8">
          <AlertDescription>
            <strong>Patent Retaliation Clause:</strong> If you initiate patent litigation against any entity alleging that s45 constitutes patent infringement, 
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="border-l-4 border-primary pl-6">
            <h3 className="font-semibold mb-2">Can I use s45 in my commercial product?</h3>
          ...
          <div className="border-l-4 border-primary pl-6">
            ...
            <p className="text-muted-foreground">
              You can apply different license terms to your modifications, but the original s45 code remains under Apache 2.0.
            </p>
          </div>
      ...
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            Learn more about the Apache License 2.0 and how to use s45:
          </p>
        </DocsBody>
          ...
          <DocsCard
            ...
            actions={[
              { 
                label: 'View License', 
                variant: 'default',
                onClick: () => window.open('https://github.com/s45-ai/s45/blob/main/LICENSE', '_blank')
              }
            ]}
          />
          <DocsCard
