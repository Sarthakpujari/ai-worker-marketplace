  ...
  return (
    <>
      ...
      <DocsBody className="mb-8">
        <h2 id="overview">What is s45?</h2>
        <p className="text-lg mb-6">
          s45 is an open source platform where you can build AI agents that handle real work. Think of it as the infrastructure and tools you need to create agents that can browse the web, manage files, analyze data, and automate workflows.
        </p>
        
        <h3 id="meet-suna">Suna - Our Flagship Agent</h3>
        <p className="mb-4">
          Suna is our showcase agent that demonstrates what's possible with s45. It's a generalist AI worker that can:
        </p>
        ...
        <p className="mb-6">
          Suna is completely open source and shows you what you can build with the s45 platform.
        </p>
        ...
        <p className="mb-4">s45 gives you four main pieces:</p>
