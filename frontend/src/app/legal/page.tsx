      ...
      <section className="w-full relative overflow-hidden pb-20">
        ...
        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE s45
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                                "Company" refers to s45 AI Corp (701 Tillery Street
        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the s45 website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the s45 website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@s45.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      s45 is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@s45ai.com and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@s45ai.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All s45 logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE s45 WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      s45 DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at s45 in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      s45 does not collect biometric or identifying
